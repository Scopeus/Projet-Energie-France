...
if page == pages[0]:
    ...
    st.plotly_chart(fig)
    st.write ("La consommation par année et région reste assez linéaire pour toutes les régions. On observe même une légère tendance à la baisse. On remarque que l'année 2022 est plus faibles car les données s'arrêtent au premier trimestre")
    st.write ("******************************************************************************************************************")
    #############################################################
    ...
    st.image(r"C:\Users\tonym\OneDrive\MOSCAT OneDrive\PROFESSIONNEL\DATASCIENTEST\Projet ENERGIE\Images\predictions vs reel.png")
