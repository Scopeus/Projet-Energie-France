...
""")
    ...
    results_algo = joblib.load('Modèles_et_résultats_JOBLIB/results_df_algo.joblib')
...
""")
    ...
    results_grid = joblib.load('Modèles_et_résultats_JOBLIB/results_df_grid.joblib')
